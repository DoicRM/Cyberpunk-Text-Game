...
//  Rados³aw "Doic" Michalak - modifications
// 
// https://gitlab.com/RachelWilShaSingh/simple-cpp-text-adventure
...
{
    out("Function starts", location);
}

void Logger::invalidHeroChoiceError(const std::string& location)
{
    error("Entered invalid value", location);
}
