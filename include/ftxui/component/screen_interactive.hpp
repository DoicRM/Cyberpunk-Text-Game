...
#include <component/receiver.hpp>  // for Receiver, Sender
...
#include "component/animation.hpp"       // for TimePoint
#include "component/captured_mouse.hpp"  // for CapturedMouse
#include "component/event.hpp"           // for Event
#include "component/task.hpp"            // for Closure, Task
#include "screen/screen.hpp"             // for Screen
