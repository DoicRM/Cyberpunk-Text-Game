...
#include <component/animation.hpp>  // for Duration, QuadraticInOut, Function
#include <dom/elements.hpp>         // for Element
#include <util/ref.hpp>             // for Ref
#include <functional>                     // for function
#include <optional>                       // for optional
#include <string>                         // for string

#include "screen/color.hpp"  // for Color, Color::GrayDark, Color::White
